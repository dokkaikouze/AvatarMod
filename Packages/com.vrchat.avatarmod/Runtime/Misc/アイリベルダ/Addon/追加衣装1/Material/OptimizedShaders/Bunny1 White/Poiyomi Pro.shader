Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/7cab205cc903eba438f00735e50e07f5"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#ifdef POI_MATCAP0_CUSTOM_NORMAL
				#if defined(PROP_MATCAP0NORMALMAP) || !defined(OPTIMIZER_ENABLED)
				normal0 = calculateNormal(poiMesh.normals[(1.0 /*_MatcapNormal*/)], poiMesh, _Matcap0NormalMap, float4(1,1,0,0), float4(0,0,0,0), (0.0 /*_Matcap0NormalMapUV*/), (1.0 /*_Matcap0NormalMapScale*/));
				#endif
				#endif
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				...
				if ((1.0 /*_MatcapSmoothnessEnabled*/))
				{
					float mipCount0 = 9;
				...
				#if defined(PROP_MATCAPMASK) || !defined(OPTIMIZER_ENABLED)
				matcapMask = POI2D_SAMPLER_PAN(_MatcapMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_MatcapMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(1.0 /*_MatcapMaskChannel*/)];
				#else
				matcapMask = 1;
				#endif
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (1.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.2 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				if ((1.0 /*_Matcap2SmoothnessEnabled*/))
				{
					...
					float matcap2Smoothness = (0.3 /*_Matcap2Smoothness*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (1.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.2 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			float3 RandomColorFromPoint(float2 rando, PoiMods poiMods)
			{
				...
				fixed value = lerp(float4(0.5,0.8,0,1).x, float4(0.5,0.8,0,1).y, rando.y);
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float2 st = (poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (800.0 /*_GlitterFrequency*/);
					...
					float size = (0.44 /*_GlitterSize*/);
					
					if ((0.0 /*_GlitterRandomSize*/))
					{
						size = lerp(float4(0,0.5,0,1).x, float4(0,0.5,0,1).y, randomFromPoint);
					}
					#ifdef POI_AUDIOLINK
					if ((0.0 /*_GlitterALEnabled*/))
					{
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						if ((1.0 /*_GlitterSpeed*/) + glitterSpeedOffset > 0)
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (90.0 /*_GlitterAngleRange*/), (1.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
						...
						float brightness = (sin((_Time.x * 10 + randomOffset +glitterSpeedOffset) * (1.0 /*_GlitterSpeed*/)) * .5 + .5);
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness = (0.658 /*_ClearCoatSmoothness*/);
				float reflectionMask = (0.276 /*_ClearCoatReflectionStrength*/);
				float specularMask = (0.341 /*_ClearCoatSpecularStrength*/);
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)
			...
			void applyEnvironmentRim(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				half enviroMask = 1;
				#if defined(PROP_RIMENVIROMASK) || !defined(OPTIMIZER_ENABLED)
				enviroMask = POI2D_SAMPLER_PAN(_RimEnviroMask, _MainTex, poiMesh.uv[(0.0 /*_RimEnviroMaskUV*/)], float4(0,0,0,0))[(1.0 /*_RimEnviroChannel*/)];
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_MainGradationStrength*/) && (1.0 /*_ColorGradingToggle*/))
				{
					#if !defined(UNITY_COLORSPACE_GAMMA)
					...
					#endif
					poiFragData.baseColor = lerp(poiFragData.baseColor, tempColor, (1.0 /*_MainGradationStrength*/));
				}
				...
				poiFragData.baseColor = saturate(lerp(poiFragData.baseColor, poiFragData.baseColor * ((-0.1 /*_MainBrightness*/) + 1), hueShiftAlpha.g));
				#endif

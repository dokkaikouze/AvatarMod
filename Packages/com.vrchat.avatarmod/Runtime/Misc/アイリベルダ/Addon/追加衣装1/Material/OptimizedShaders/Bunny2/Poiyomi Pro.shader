Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/23efe40527de9db408dd7d615d31f874"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.0.α05</color>", Float) = 0
		...
		[sRGBWarning]_AlphaMask ("Alpha Map--{reference_properties:[_AlphaMaskPan, _AlphaMaskUV, _AlphaMaskInvert, _AlphaMaskMode, _AlphaMaskScale, _AlphaMaskValue]}", 2D) = "white" { }
		...
		[HideInInspector][ThryWideEnum(Off, 0, Replace, 1, Multiply, 2, Add, 3, Subrtract, 4)]_AlphaMaskMode ("Blend Mode", Int) = 2
		...
		[HideInInspector] m_start_ShadingGlobalMask ("Global Mask", Int) = 0
		...
		[HideInInspector] m_end_ShadingGlobalMask ("Global Mask", Int) = 0
		...
		[sRGBWarning(true)][Gradient]_Matcap ("Matcap--{reference_properties:[_MatcapUVToBlend, _MatCapBlendUV1]}", 2D) = "white" { }
		...
		[HideInInspector] g_start_matcapApplyToAlpha ("Apply to Alpha--{draw_border:true,condition_expand:_MatcapApplyToAlphaEnabled==1,reference_property:_MatcapApplyToAlphaEnabled}", Float) = 0
		[HideInInspector][ToggleUI] _MatcapApplyToAlphaEnabled ("", Float) = 0
		[ThryWideEnum(Greyscale, 0, Max, 1)] _MatcapApplyToAlphaSourceBlend ("Source Blend", Int) = 0
		[ThryWideEnum(Add, 0, Multiply, 1)] _MatcapApplyToAlphaBlendType ("Blend Type", Int) = 0
		_MatcapApplyToAlphaBlending ("Blending", Range(0, 1)) = 1.0
		[HideInInspector] g_end_matcapApplyToAlpha ("", Float) = 0
		...
		[sRGBWarning(true)][Gradient]_Matcap2 ("Matcap--{reference_properties:[_Matcap2UVToBlend,_MatCap2ndBlendUV1]}", 2D) = "white" { }
		...
		[ThryWideEnum(Add, 0, Replace, 1, Multiply, 2, Mixed, 3)] _RimPoi2BlendMode ("Blend Mode--{ condition_showS:_Rim2Style==0}", Int) = 0
		...
		[ThryWideEnum(Off, 0, Add, 1, Multiply, 2)]_Rim2ApplyAlpha ("Apply to Alpha--{ condition_showS:_Rim2Style==0}", Int) = 0
		_Rim2ApplyAlphaBlend ("Apply to Alpha Blend--{ condition_showS:_Rim2Style==0}", Range(0, 1)) = 1.0
		...
		[ThryWideEnum(Normal, 0, Add, 1, Screen, 2, Multiply, 3)]_Rim2BlendMode ("Blend Mode", Int) = 1
		[HideInInspector] g_start_liltoon_rim2_lightdir ("Light Direction--{draw_border:true, condition_showS:_Rim2Style==2}", Float) = 0
		...
		[HideInInspector] g_end_liltoon_rim2_lightdir ("", Float) = 0
		...
		[HideInInspector] m_start_LTCGI ("LTCGI--{reference_property:_LTCGIEnabled}", Float) = 0
		...
		[HideInInspector] g_start_EmissionAL0Multiply ("Strength Multiply--{draw_border:true, condition_showS:(_EmissionAL0Enabled==1 && _EnableAudioLink==1)}", Float) = 0
		[Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3, Volume, 4)] _EmissionAL0MultipliersBand ("Band--{ condition_showS:(_EmissionAL0Enabled==1 && _EnableAudioLink==1)}", Int) = 0
		[VectorLabel(Min, Max)]_EmissionAL0Multipliers ("Multiplier--{ condition_showS:(_EmissionAL0Enabled==1 && _EnableAudioLink==1)}", Vector) = (1, 1, 0, 0)
		[HideInInspector] g_end_EmissionAL0Multiply ("Strength Multiply--{draw_border:true}", Float) = 0
		[HideInInspector] g_start_EmissionAL0Add ("Strength Add--{draw_border:true, condition_showS:(_EmissionAL0Enabled==1 && _EnableAudioLink==1)}", Float) = 0
		[Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3, Volume, 4)] _EmissionAL0StrengthBand ("Band--{ condition_showS:(_EmissionAL0Enabled==1 && _EnableAudioLink==1)}", Int) = 0
		[VectorLabel(Min, Max)]_EmissionAL0StrengthMod ("Strength--{ condition_showS:(_EmissionAL0Enabled==1 && _EnableAudioLink==1)}", Vector) = (0, 0, 0, 0)
		[HideInInspector] g_end_EmissionAL0Add ("Strength Add--{draw_border:true}", Float) = 0
		[HideInInspector] g_start_EmissionAL0COut ("Center Out--{draw_border:true, condition_showS:(_EmissionAL0Enabled==1 && _EnableAudioLink==1)}", Float) = 0
		[Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3, Volume, 4)] _AudioLinkEmission0CenterOutBand ("Band--{ condition_showS:(_EmissionAL0Enabled==1 && _EnableAudioLink==1)}", Int) = 0
		[VectorLabel(Min, Max)] _AudioLinkEmission0CenterOut ("Strength--{ condition_showS:(_EmissionAL0Enabled==1 && _EnableAudioLink==1)}", Vector) = (0, 0, 0, 0)
		...
		[HideInInspector] g_end_EmissionAL0COut ("Center Out--{draw_border:true}", Float) = 0
		...
		[HideInInspector] g_start_EmissionAL1Multiply ("Strength Multiply--{draw_border:true, condition_showS:(_EmissionAL1Enabled==1 && _EnableAudioLink==1)}", Float) = 0
		[Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3, Volume, 4)] _EmissionAL1MultipliersBand ("Band--{ condition_showS:(_EmissionAL1Enabled==1 && _EnableAudioLink==1)}", Int) = 0
		[VectorLabel(Min, Max)]_EmissionAL1Multipliers ("Multiplier--{ condition_showS:(_EmissionAL1Enabled==1 && _EnableAudioLink==1)}", Vector) = (1, 1, 0, 0)
		[HideInInspector] g_end_EmissionAL1Multiply ("Strength Multiply--{draw_border:true}", Float) = 0
		[HideInInspector] g_start_EmissionAL1Add ("Strength Add--{draw_border:true, condition_showS:(_EmissionAL1Enabled==1 && _EnableAudioLink==1)}", Float) = 0
		[Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3, Volume, 4)] _EmissionAL1StrengthBand ("Band--{ condition_showS:(_EmissionAL1Enabled==1 && _EnableAudioLink==1)}", Int) = 0
		[VectorLabel(Min, Max)]_EmissionAL1StrengthMod ("Strength Add--{ condition_showS:(_EmissionAL1Enabled==1 && _EnableAudioLink==1)}", Vector) = (0, 0, 0, 0)
		[HideInInspector] g_end_EmissionAL1Add ("Strength Add--{draw_border:true}", Float) = 0
		[HideInInspector] g_start_EmissionAL1COut ("Center Out--{draw_border:true, condition_showS:(_EmissionAL1Enabled==1 && _EnableAudioLink==1)}", Float) = 0
		[Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3, Volume, 4)] _AudioLinkEmission1CenterOutBand ("Band--{ condition_showS:(_EmissionAL1Enabled==1 && _EnableAudioLink==1)}", Int) = 0
		[VectorLabel(Min, Max)] _AudioLinkEmission1CenterOut ("Strength--{ condition_showS:(_EmissionAL1Enabled==1 && _EnableAudioLink==1)}", Vector) = (0, 0, 0, 0)
		...
		[HideInInspector] g_end_EmissionAL1COut ("Center Out--{draw_border:true}", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				else if ((1.0 /*_LightingAdditiveType*/) == 1) // Toon
				{
					...
					#endif
					if ((0.75 /*_LightingAdditiveGradientEnd*/) == (0.3 /*_LightingAdditiveGradientStart*/)) (0.75 /*_LightingAdditiveGradientEnd*/) += 0.001;
					poiLight.rampedLightMap = smoothstep((0.75 /*_LightingAdditiveGradientEnd*/), (0.3 /*_LightingAdditiveGradientStart*/), 1 - (.5 * poiLight.nDotL + .5));
					#if defined(POINT) || defined(SPOT)
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.additiveShadow, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.3 /*_LightingAdditiveGradientStart*/), (0.75 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5))) * poiLight.attenuation;
					#else
					poiLight.finalLighting = lerp(poiLight.directColor * max(min(poiLight.attenuation, poiLight.detailShadow), passthrough), poiLight.indirectColor, smoothstep((0.3 /*_LightingAdditiveGradientStart*/), (0.75 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.nDotL + .5)));
					#endif
					return;
				}
				#endif
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						{
							vertexLighting += lerp(poiLight.vColor[index] * poiLight.vAttenuation[index], poiLight.vColor[index] * (0.35 /*_LightingAdditivePassthrough*/) * poiLight.vAttenuation[index], smoothstep((0.3 /*_LightingAdditiveGradientStart*/), (0.75 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.vDotNL[index] + .5))) * poiLight.detailShadow;
						}
					}
			...
			void getMatcapUV(inout float2 matcapUV, in float matcapUVMode, in float matcapUVToBlend, in float2 matCapBlendUV, in float matcapRotation, in float matcapBorder, in float3 normal, in PoiCam poiCam, in PoiLight poiLight, in PoiMesh poiMesh)
			{
				switch(matcapUVMode)
				{
					case 0:
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#ifdef POI_MATCAP0_CUSTOM_NORMAL
				#if defined(PROP_MATCAP0NORMALMAP) || !defined(OPTIMIZER_ENABLED)
				normal0 = calculateNormal(poiMesh.normals[(1.0 /*_MatcapNormal*/)], poiMesh, _Matcap0NormalMap, float4(1,1,0,0), float4(0,0,0,0), (0.0 /*_Matcap0NormalMapUV*/), (1.93 /*_Matcap0NormalMapScale*/));
				#endif
				#endif
				getMatcapUV(matcapUV, (1.0 /*_MatcapUVMode*/), (1.0 /*_MatcapUVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_MatcapRotation*/), (0.5 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh);
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					float mipCount0 = 9;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 8192) mipCount0 = 13;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 4096) mipCount0 = 12;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 2048) mipCount0 = 11;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 1024) mipCount0 = 10;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 512) mipCount0 = 9;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 256) mipCount0 = 8;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 128) mipCount0 = 7;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 64) mipCount0 = 6;
					if (float4(0.0009765625,0.0009765625,1024,1024).z == 32) mipCount0 = 5;
					float matcapSmoothness = (0.58 /*_MatcapSmoothness*/);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.2 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				float3 normal1 = poiMesh.normals[(1.0 /*_Matcap2Normal*/)];
				getMatcapUV(matcapUV, (1.0 /*_Matcap2UVMode*/), (1.0 /*_Matcap2UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap2Rotation*/), (0.5 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh);
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				if ((1.0 /*_Matcap2SmoothnessEnabled*/))
				{
					float mipCount2 = 9;
					...
					float matcap2Smoothness = (0.77 /*_Matcap2Smoothness*/);
				...
				matcap2.rgb = lerp(matcap2.rgb, matcap2.rgb * poiFragData.baseColor.rgb, (0.7 /*_Matcap2BaseColorMix*/));
				#if defined(PROP_MATCAP2MASK) || !defined(OPTIMIZER_ENABLED)
				...
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.2 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.1 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), (0.2 /*_GITDEMinEmissionMultiplier*/), (0.0 /*_GITDEMaxEmissionMultiplier*/), (1.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/), poiLight);
				#if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled*/))
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,0.1019608).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,0.1019608).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,0.1019608).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength1 = (1.0 /*_EmissionStrength1*/);
				...
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,0.5019608).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,0.5019608).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,0.5019608).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
			...
			void ApplyLiltoonRimLighting(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods, float4 RimColor, float4 RimIndirColor, float4 RimColorTex, float RimMainStrength, float RimNormalStrength, float RimDirRange, float RimIndirRange, float RimFresnelPower, float RimBackfaceMask, float RimDirStrength, float RimBorder, float RimBlur, float RimIndirBorder, float RimIndirBlur, float RimShadowMask, float RimEnableLighting, float RimVRParallaxStrength, float RimGlobalMask, float RimGlobalMaskBlendType, float RimHueShiftEnabled, float RimHueShift, float RimHueShiftSpeed, float RimClamp, int RimBlendMode)
			{
				...
				float3 lightCol = poiLight.directColor + poiLight.indirectColor;
				...
				#endif
				poiFragData.baseColor = lilBlendColor(poiFragData.baseColor, rimColor.rgb, rimDir * rimColor.a, RimBlendMode);
				poiFragData.baseColor = lilBlendColor(poiFragData.baseColor, rimIndirColor.rgb, rimIndir * rimIndirColor.a, RimBlendMode);
				if(RimClamp)
				{
					poiFragData.baseColor = saturate(poiFragData.baseColor);
				}
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness = (0.833 /*_ClearCoatSmoothness*/);
				float reflectionMask = (0.276 /*_ClearCoatReflectionStrength*/);
				float specularMask = (0.878 /*_ClearCoatSpecularStrength*/);
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)
				...
				if ((3.0 /*_ClearCoatMapsClearCoatMaskChannel*/) < 4)
				{
					clearCoatMask *= PBRMaps[(3.0 /*_ClearCoatMapsClearCoatMaskChannel*/)];
				}
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						vSpecular += poiLight.vColor[index] * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_ClearCoatSpecularTintThemeIndex*/)) * poiLight.occlusion * poiLight.vAttenuation[index];
					}
					#endif
				}
			...
			{
				float3 backlightColor = float4(0.3197627,0.2799534,0.2094192,1).rgb;
				#if defined(PROP_BACKLIGHTCOLORTEX) || !defined(OPTIMIZER_ENABLED)
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (0.07 /*_BumpScale*/));
				#else
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? min(_LightingAdditiveLimit, unity_LightColor[index].rgb) : unity_LightColor[index].rgb;
						poiLight.vColor[index] = lerp(poiLight.vColor[index], dot(poiLight.vColor[index], float3(0.299, 0.587, 0.114)), (0.15 /*_LightingAdditiveMonochromatic*/));
				...
				poiLight.directColor = lerp(poiLight.directColor, dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), (0.15 /*_LightingMonochromatic*/));
				poiLight.indirectColor = lerp(poiLight.indirectColor, dot(poiLight.indirectColor, float3(0.299, 0.587, 0.114)), (0.15 /*_LightingMonochromatic*/));
				...
				poiLight.directColor = (1.0 /*_LightingAdditiveLimited*/) ? min(_LightingAdditiveLimit, _LightColor0.rgb) : _LightColor0.rgb;
				#if defined(POINT_COOKIE) || defined(DIRECTIONAL_COOKIE)
				poiLight.indirectColor = 0;
				#else
				poiLight.indirectColor = lerp(0, poiLight.directColor, (0.35 /*_LightingAdditivePassthrough*/));
				poiLight.indirectColor = (1.0 /*_LightingAdditiveLimited*/) ? min(_LightingAdditiveLimit, poiLight.indirectColor) : poiLight.indirectColor;
				#endif
				poiLight.directColor = lerp(poiLight.directColor, dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), (0.15 /*_LightingAdditiveMonochromatic*/));
				poiLight.indirectColor = lerp(poiLight.indirectColor, dot(poiLight.indirectColor, float3(0.299, 0.587, 0.114)), (0.15 /*_LightingAdditiveMonochromatic*/));
				poiLight.halfDir = normalize(poiLight.direction + poiCam.viewDir);
				poiLight.nDotL = dot(poiMesh.normals[1], poiLight.direction);
				poiLight.nDotLSaturated = saturate(poiLight.nDotL);
				poiLight.nDotLNormalized = (poiLight.nDotL + 1) * 0.5;
				...
				{
					float LTCGIsmoothness = (0.833 /*_LTCGI_Smoothness*/);
					float LTCGImetalness = (0.656 /*_LTCGI_Metallic*/);
				...
				if ((1.0 /*_FXProximityColor*/))
				{
					...
					poiFragData.finalColor *= lerp(poiThemeColor(poiMods, float4(0.05278492,0.05278492,0.05278492,1).rgb, (0.0 /*_FXProximityColorMinColorThemeIndex*/)), poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_FXProximityColorMaxColorThemeIndex*/)), smoothstep((0.025 /*_FXProximityColorMinDistance*/), (0.09 /*_FXProximityColorMaxDistance*/), distance(position, poiCam.worldPos)));
					if ((0.0 /*_FXProximityColorBackFace*/))
					{
						poiFragData.finalColor = lerp(poiFragData.finalColor * float4(0.05278492,0.05278492,0.05278492,1).rgb, poiFragData.finalColor, saturate(poiMesh.isFrontFace));
					}
				}
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.3185468,0.2746773,0.4910209,1);
				#ifdef POI_AUDIOLINK

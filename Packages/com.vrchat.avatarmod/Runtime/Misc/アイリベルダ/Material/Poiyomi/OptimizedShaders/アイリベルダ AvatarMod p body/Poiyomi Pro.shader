Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/4939dd3a02cc74747b713760eba4c0af"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#ifdef POI_MATCAP1_CUSTOM_NORMAL
				#if defined(PROP_MATCAP1NORMALMAP) || !defined(OPTIMIZER_ENABLED)
				normal1 = calculateNormal(poiMesh.normals[(1.0 /*_Matcap2Normal*/)], poiMesh, _Matcap1NormalMap, float4(35,35,0,0), float4(0,0,0,0), (0.0 /*_Matcap1NormalMapUV*/), (0.3 /*_Matcap1NormalMapScale*/));
				#endif
				#endif
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				...
				#if defined(PROP_MATCAP3MASK) || !defined(OPTIMIZER_ENABLED)
				matcap3Mask = POI2D_SAMPLER_PAN(_Matcap3Mask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Matcap3MaskUV*/)], float4(0.5,0.5,0,-0.5)), float4(0,0,0,0))[(1.0 /*_Matcap3MaskChannel*/)];
				#else
				matcap3Mask = 1;
				#endif
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				for (uint glitterLayer = 0; glitterLayer < uint((2.0 /*_GlitterLayers*/)); glitterLayer++)
				{
					...
					#if defined(PROP_GLITTERMASK) || !defined(OPTIMIZER_ENABLED)
					float glitterMask = POI2D_SAMPLER_PAN(_GlitterMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_GlitterMaskUV*/)], float4(0.5,0.5,0,-0.5)), float4(0,0,0,0))[(1.0 /*_GlitterMaskChannel*/)];
					#else
					float glitterMask = 1;
					#endif
					#ifdef POI_AUDIOLINK

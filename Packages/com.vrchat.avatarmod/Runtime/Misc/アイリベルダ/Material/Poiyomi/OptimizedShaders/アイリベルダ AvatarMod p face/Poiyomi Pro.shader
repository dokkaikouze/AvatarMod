Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/33deac97a2f62244c84ee561afce3b65"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float calculateSSAO(PoiMesh poiMesh, PoiCam poiCam, inout PoiLight poiLight, inout PoiMods poiMods)
			{
				...
				#ifdef SSAO_MASK_TEX
				#if defined(PROP_SSAOMASK) || !defined(OPTIMIZER_ENABLED)
				mask = POI2D_SAMPLER_PAN(_SSAOMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_SSAOMaskUV*/)], float4(0.5,0.5,0.5,0)), float4(0,0,0,0))[(1.0 /*_SSAOMaskChannel*/)];

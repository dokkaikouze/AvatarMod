Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/daec6b30add6c1a4e836b2400e96e5dd"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float LTCGIsmoothness = (0.826 /*_LTCGI_Smoothness*/);
					...
					acc.specular *= poiThemeColor(poiMods, float4(0.4061945,0.4061945,0.4061945,1).rgb, (0 /*_LTCGI_SpecularColorThemeIndex*/));
					acc.diffuse *= poiThemeColor(poiMods, float4(0.5754442,0.5754442,0.5754442,1).rgb, (0 /*_LTCGI_DiffuseColorThemeIndex*/));

Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/7cfa9857289fd344d9a3f7bff2cbdc52"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.13 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (0.0 /*_Matcap4Multiply*/), (0.0 /*_Matcap4Replace*/), (1.0 /*_Matcap4Mixed*/), (0.0 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif

Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/15e9a30b8158c234293d2c22931fbe5a"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMainColor(inout PoiFragData poiFragData, inout PoiMesh poiMesh, inout PoiCam poiCam, inout PoiMods poiMods, inout float4 mainTexture)
			{
				...
				if (2.0)
				{
					...
					#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
					alphaMaskTex = POI2D_SAMPLER_PAN(_AlphaMask, _MainTex, poiUV(poiMesh.uv[0.0], float4(4,4,0,0)), float4(0,0,0,0).xy);
					#endif

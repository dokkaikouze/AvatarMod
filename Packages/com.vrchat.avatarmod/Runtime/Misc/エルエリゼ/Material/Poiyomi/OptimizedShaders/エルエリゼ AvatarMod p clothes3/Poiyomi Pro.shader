Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/b563b8f88b0c5c5418042f1428c23519"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness = (0.777 /*_ClearCoatSmoothness*/);
				float reflectionMask = (0.26 /*_ClearCoatReflectionStrength*/);
				float specularMask = (0.125 /*_ClearCoatSpecularStrength*/);
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)

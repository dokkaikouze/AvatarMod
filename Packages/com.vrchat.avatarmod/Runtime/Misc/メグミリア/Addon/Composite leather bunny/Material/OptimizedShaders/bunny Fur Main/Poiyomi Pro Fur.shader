 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((0.0 /*_UDIMDiscardMode*/) == 0) // Discard Vertices instead of just pixels
				{
					...
					isDiscarded += (udim.y >= 1 && udim.y < 2) * dot(float4((0.0 /*_UDIMDiscardRow1_0*/), (0.0 /*_UDIMDiscardRow1_1*/), (0.0 /*_UDIMDiscardRow1_2*/), (0.0 /*_UDIMDiscardRow1_3*/)), xMask);
					isDiscarded += (udim.y >= 2 && udim.y < 3) * dot(float4((0.0 /*_UDIMDiscardRow2_0*/), (0.0 /*_UDIMDiscardRow2_1*/), (0.0 /*_UDIMDiscardRow2_2*/), (0.0 /*_UDIMDiscardRow2_3*/)), xMask);
			...
			void applyFur(in float2 furSettings, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					furTexture.rgb = hueShift(furTexture.rgb, (0.0 /*_FurHueShift*/) + _Time.x * (0.0 /*_FurHueShiftSpeed*/), (0.0 /*_FurHueShiftColorSpace*/), (1.0 /*_FurHueSelectOrShift*/));
				}
				furTexture.rgb *= ao;
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if (float4(0.6514057,0.5972019,0.8879232,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(0.6514057,0.5972019,0.8879232,1).rgb;
				}
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.45 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (1.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.3 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness = (0.512 /*_ClearCoatSmoothness*/);
				float reflectionMask = (0.292 /*_ClearCoatReflectionStrength*/);
				float specularMask = (0.924 /*_ClearCoatSpecularStrength*/);
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)

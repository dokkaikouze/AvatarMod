Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/e325333dfb1e15a4da96afabf4cdb82e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAnisotropics(inout PoiFragData poiFragData, inout PoiLight poiLight, in PoiCam poiCam, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float spec0 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (1.0 /*_Aniso0SwitchDirection*/)), (0.0 /*_Aniso0Offset*/) +(0.0 /*_Aniso0OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.direction, (0.431 /*_Aniso0Power*/) * 1000, (0.029 /*_Aniso0Strength*/), shadowMask);
				float spec1 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso1SwitchDirection*/)), (0.0 /*_Aniso1Offset*/) +(0.0 /*_Aniso1OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.direction, (0.259 /*_Aniso1Power*/) * 1000, (0.139 /*_Aniso1Strength*/), shadowMask);
				spec0 = lerp(spec0, aaEdgeFeather(spec0, (1.0 /*_Aniso0Edge*/), (0.0 /*_Aniso0Blur*/)), (0.0 /*_Aniso0ToonMode*/));
				spec1 = lerp(spec1, aaEdgeFeather(spec1, (1.0 /*_Aniso1Edge*/), (0.0 /*_Aniso1Blur*/)), (0.0 /*_Aniso1ToonMode*/));
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						float vSpec0 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (1.0 /*_Aniso0SwitchDirection*/)), (0.0 /*_Aniso0Offset*/) +(0.0 /*_Aniso0OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.vDirection[index], (0.431 /*_Aniso0Power*/) * 1000, (0.029 /*_Aniso0Strength*/), poiLight.vSaturatedDotNL[index]);
						float vSpec1 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso1SwitchDirection*/)), (0.0 /*_Aniso1Offset*/) +(0.0 /*_Aniso1OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.vDirection[index], (0.259 /*_Aniso1Power*/) * 1000, (0.139 /*_Aniso1Strength*/), poiLight.vSaturatedDotNL[index]);
						vSpec0 = lerp(vSpec0, aaEdgeFeather(vSpec0, (1.0 /*_Aniso0Edge*/), (0.0 /*_Aniso0Blur*/)), (0.0 /*_Aniso0ToonMode*/));
						vSpec1 = lerp(vSpec1, aaEdgeFeather(vSpec1, (1.0 /*_Aniso1Edge*/), (0.0 /*_Aniso1Blur*/)), (0.0 /*_Aniso1ToonMode*/));
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (1.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				#ifdef POI_MATCAP1_CUSTOM_NORMAL
				#if defined(PROP_MATCAP1NORMALMAP) || !defined(OPTIMIZER_ENABLED)
				normal1 = calculateNormal(poiMesh.normals[(1.0 /*_Matcap2Normal*/)], poiMesh, _Matcap1NormalMap, float4(26,26,0,0), float4(0,0,0,0), (0.0 /*_Matcap1NormalMapUV*/), (0.3 /*_Matcap1NormalMapScale*/));
				#endif
				#endif
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				matcapIntensity = (0.8 /*_Matcap2Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				#if defined(PROP_MATCAP3MASK) || !defined(OPTIMIZER_ENABLED)
				matcap3Mask = POI2D_SAMPLER_PAN(_Matcap3Mask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Matcap3MaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(1.0 /*_Matcap3MaskChannel*/)];
				#else
				matcap3Mask = 1;
				#endif
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap3Add*/), (0.0 /*_Matcap3AddToLight*/), (0.0 /*_Matcap3Multiply*/), (0.0 /*_Matcap3Replace*/), (0.7 /*_Matcap3Mixed*/), (0.0 /*_Matcap3Screen*/), matcap3, matcap3Mask, (0.0 /*_Matcap3EmissionStrength*/), (0.0 /*_Matcap3LightMask*/), (0.0 /*_Matcap3MaskGlobalMask*/), (2.0 /*_Matcap3MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float2 st = (poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (150.0 /*_GlitterFrequency*/);
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						if ((6.0 /*_GlitterSpeed*/) + glitterSpeedOffset > 0)
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (90.0 /*_GlitterAngleRange*/), (6.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
						...
						float brightness = (sin((_Time.x * 10 + randomOffset +glitterSpeedOffset) * (6.0 /*_GlitterSpeed*/)) * .5 + .5);
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness = (0.4 /*_ClearCoatSmoothness*/);
				float reflectionMask = (0.25 /*_ClearCoatReflectionStrength*/);
				float specularMask = (0.778 /*_ClearCoatSpecularStrength*/);
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)
			...
			void CalculateUTSSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#if defined(PROP_SET_HIGHCOLORMASK) || !defined(OPTIMIZER_ENABLED)
				float specularMask = POI2D_SAMPLER_PAN(_Set_HighColorMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Set_HighColorMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_Set_HighColorMaskChannel*/)];
				#else
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float LTCGIsmoothness = (0.233 /*_LTCGI_Smoothness*/);
					float LTCGImetalness = (0.05 /*_LTCGI_Metallic*/);

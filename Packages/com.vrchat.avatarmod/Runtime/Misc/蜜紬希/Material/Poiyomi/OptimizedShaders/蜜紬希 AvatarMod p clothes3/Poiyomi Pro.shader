Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/dd1d17fa593cfc942badb6cb2e707910"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAnisotropics(inout PoiFragData poiFragData, inout PoiLight poiLight, in PoiCam poiCam, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				if ((1.0 /*_AnisoGlobalMask*/) > 0)
				{
					shadowMask = customBlend(shadowMask, poiMods.globalMask[(1.0 /*_AnisoGlobalMask*/) - 1], (2.0 /*_AnisoGlobalMaskBlendType*/));
				}
				...
				float spec1 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso1SwitchDirection*/)), (0.0 /*_Aniso1Offset*/) +(0.0 /*_Aniso1OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.direction, (0.1 /*_Aniso1Power*/) * 1000, (0.6 /*_Aniso1Strength*/), shadowMask);
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						float vSpec1 = calculateAnisotropics(lerp(poiMesh.binormal[1], poiMesh.tangent[1], (0.0 /*_Aniso1SwitchDirection*/)), (0.0 /*_Aniso1Offset*/) +(0.0 /*_Aniso1OffsetMapStrength*/) * specMap.a, poiMesh.normals[1], poiCam.viewDir, poiLight.vDirection[index], (0.1 /*_Aniso1Power*/) * 1000, (0.6 /*_Aniso1Strength*/), poiLight.vSaturatedDotNL[index]);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_MatcapSmoothnessEnabled*/))
				{
					...
					float matcapSmoothness = (0.6 /*_MatcapSmoothness*/);
				...
				#endif
				matcapIntensity = (0.27 /*_MatcapIntensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.13 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (1.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (1.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (1.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness = (0.431 /*_ClearCoatSmoothness*/);
				...
				if ((0.0 /*_ClearCoatMapsRoughnessChannel*/) < 4)
				{
					smoothness *= PBRMaps[(0.0 /*_ClearCoatMapsRoughnessChannel*/)];
				}
				if ((4.0 /*_ClearCoatMapsReflectionMaskChannel*/) < 4)
				{
					reflectionMask *= PBRMaps[(4.0 /*_ClearCoatMapsReflectionMaskChannel*/)];
				}
				if ((0.0 /*_ClearCoatMapsSpecularMaskChannel*/) < 4)
				{
					specularMask *= PBRMaps[(0.0 /*_ClearCoatMapsSpecularMaskChannel*/)];
				}
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((4.0 /*_MainAlphaMaskMode*/))
				{
					...
					float alphaMask = 1;
					#endif
					alphaMask = saturate(alphaMask * _AlphaMaskBlendStrength + ((0.0 /*_AlphaMaskInvert*/) ? (0.0 /*_AlphaMaskValue*/) * - 1 : (0.0 /*_AlphaMaskValue*/)));
					if ((0.0 /*_AlphaMaskInvert*/)) alphaMask = 1 - alphaMask;
					if ((4.0 /*_MainAlphaMaskMode*/) == 1) poiFragData.alpha = alphaMask;
					if ((4.0 /*_MainAlphaMaskMode*/) == 2) poiFragData.alpha = poiFragData.alpha * alphaMask;
					if ((4.0 /*_MainAlphaMaskMode*/) == 3) poiFragData.alpha = saturate(poiFragData.alpha + alphaMask);
					if ((4.0 /*_MainAlphaMaskMode*/) == 4) poiFragData.alpha = saturate(poiFragData.alpha - alphaMask);
				}
				...
				{
					float LTCGIsmoothness = (0.431 /*_LTCGI_Smoothness*/);
					float LTCGImetalness = (0.366 /*_LTCGI_Metallic*/);

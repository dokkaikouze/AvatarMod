Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/dd1d17fa593cfc942badb6cb2e707910"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyShadeMapping(inout PoiFragData poiFragData, PoiMesh poiMesh, inout PoiLight poiLight)
			{
				...
				firstShadeMap.rgb *= float4(0.7619693,0.5775805,0.7835379,1).rgb; //* lighColor
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((4.0 /*_MainAlphaMaskMode*/))
				{
					...
					alphaMask = saturate(alphaMask * _AlphaMaskBlendStrength + ((0.0 /*_AlphaMaskInvert*/) ?_AlphaMaskValue * -1 : (0.0 /*_AlphaMaskValue*/)));

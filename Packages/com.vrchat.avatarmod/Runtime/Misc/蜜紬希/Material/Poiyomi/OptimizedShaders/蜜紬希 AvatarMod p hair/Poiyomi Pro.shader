Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/a2c9b9bbff09c3d4abac1e790d975a5c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if (float4(0.7991028,0.6038274,0.6920712,1).a > 0)
				{
					#if defined(PROP_SHADOWCOLORTEX) || !defined(OPTIMIZER_ENABLED)
					...
					#endif
					indirectColor = lerp(float3(1, 1, 1), shadowColorTex.rgb, shadowColorTex.a) * float4(0.7991028,0.6038274,0.6920712,1).rgb;
				}
